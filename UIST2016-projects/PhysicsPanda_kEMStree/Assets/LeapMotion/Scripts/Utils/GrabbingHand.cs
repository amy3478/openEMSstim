...
public class GrabbingHand : MonoBehaviour {
  ...
  protected Collider FindClosestGrabbableObject(Vector3 pinch_position) {
    ...
    for (int j = 0; j < close_things.Length; ++j) {
	  ...
	  // Finds the closest sqr distance in grabble object
  ...
  protected void Hover() {
	...
	protected void StartHoldBall() {
		...
		active_object_.transform.position = palm_position_;
...
//	Debug.Log ("Finger Proximal length: " + proximal_length);
//	Debug.Log ("Grab trigger finger ratio: " + grabTriggerDistance);
//	Debug.Log ("Grab Trigger Distance: " + trigger_distance);
